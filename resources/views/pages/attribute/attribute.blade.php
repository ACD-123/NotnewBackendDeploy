...
<div class="button-calen">
    ...
    <a href="attribute-form" class="btn form_btn">
        <i class="fas fa-upload"></i> Upload new Attribute
    </a>
</div>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="status-active">{{ $attribute->active === 1 ? 'Active' : 'In-Active' }} </span></td>
                        <td><span class="type-product">{{ $attribute->type }}</span></td>
                        <td>{{ $attribute->created_at }}</td>
                        <td>
                            <a href="{{url('/attributeEdit',$attribute->id)}}" class="btn btn-edit"><i class="fas fa-pen"></i></a>
